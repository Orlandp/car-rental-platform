...
const VARIANTS = {
  primary:
    "bg-brand-600 text-white shadow-sm shadow-brand-600/20 hover:bg-brand-700 focus-visible:outline-brand-600 disabled:bg-muted/40 disabled:text-muted disabled:shadow-none",
  secondary:
    "bg-surface text-text border border-border hover:bg-surface-hover focus-visible:outline-brand-600 disabled:text-muted disabled:cursor-not-allowed",
  ghost:
    "bg-transparent text-text hover:bg-surface-hover focus-visible:outline-brand-600 disabled:text-muted",
  danger:
